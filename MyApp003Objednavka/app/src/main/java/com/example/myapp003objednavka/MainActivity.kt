...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rbBike1.setOnClickListener {
            binding.ivBike.setImageResource(R.drawable.oiz_10_tr)
        }
        binding.rbBike2.setOnClickListener {
            binding.ivBike.setImageResource(R.drawable.oiz_20_tr)
        }
        binding.rbBike3.setOnClickListener {
            binding.ivBike.setImageResource(R.drawable.oiz_30_tr)
        }
    }
}